...
class PatientDetailsScreen extends Component{
    constructor(){
        ...
        componentDidMount(){
            ...
            let query = ref.orderByChild("Id").equalTo("-Mc4l-csOIWqbW5JQeiu");
   ...
   Savepatient = () => {
       UpdatePatient(this.state.Id,this.state.Name, this.state.Address, this.state.Age,
